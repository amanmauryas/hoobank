  ...
  <section id="home" className={`flex
    ...
    bg-discount-gradient rounded-[10px] mb-2">
      ...
      text-white ss:leading-[100px] leading-[75px]'>The Next <br className='sm:block hidden' /> {""}
        ...
        <div className="ss:flex hidden md:m5-4 mr-0">
          <GetStarted />
        </div>
      </div>
...
//                                       Image section starts from here */}
    ...
    <div>
      ...
      <div className="absolute z-[0] w-[30%] h-[35%] top-0 pink__gradient"></div>
      <div className="absolute z-[1] w-[30%] h-[30%] rounded-full bottom-40 blue__gradient"></div>
      {/* <div className="absolute z-[0] w-[30%] h-[30%] right-20 bottom-20 white__gradient"></div> */}
